...
impl Observation {
    ...
    pub async fn get_observations(
        ...
        //         // interpolate
        //         let daily_observations_from_monthly_observations_interpolated =
        //             linearly_interpolate_monthly_observations(obs);
        //     } else {
    ...
    //                 monthly_observations[*x1usize].date_observation + idx_duration;
